...
public class Config {
    ...
    @Value("${KAFKA_EXTERNAL_LISTENER_PORT}")
    private String kafkaExternalListenerPort;

    @Bean
    public ConsumerFactory<String, GraphDataModelsWrapper> graphModelConsumer() {
        Map<String, Object> props = Map.of(
            ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaBrokerUrl + ":" + kafkaExternalListenerPort,
